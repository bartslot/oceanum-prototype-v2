...
import * as animationPath from './starIncrease.json'
...
function Lottie(props) {
  ...
  const { id, options, eventListeners, playingState, className, direction, speed, animationDelay, goToAndPlay, playSegments,  } = props
...
const defaultOptions = {
  ...
  loop: false,
  autoplay: false,
  path: animationPath, // the animation data
  rendererSettings: {
